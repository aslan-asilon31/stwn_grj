<?php include'header.php';?>
	...
	<!-- Home -->
<head>
	<title>Gereja Pelayanan Penyembahan Karismatik</title>
</head>
	<div class="home">
							...
							<div class="row">
								<div class="col">
									<div class="home_content_inner">
										<div class="home_title"><h1>GEREJA GPPK BEKASI</h1></div>
										<div class="home_text">
											<p>GEREJA GPPK BEKASI Gereja yang dirindukan Jemaat </p>
										</div>
									</div>
								</div>
							</div>
