...
/* Gaya semua link dalam dropdown */
.dropdown-menu a {
	display: block;
	padding: 10px 16px;
	color: #333;
				...
				<div class="row">
					<div class="col">
						<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
							...
							<div class="top_bar_item"><a href="contact.php">Jln.Budi Kemasyarakatan No. 5 Pulo Brayan Kota, Medan</a></div>
								...
								<ul>
									...
									<li class="dropdown">
										...
										<div class="dropdown-menu">
											<a href="pendaftaran.php" class="dropdown-item">Pendaftaran Jemaat</a>
											<a href="admin" class="dropdown-item">Login</a>
										</div>
									</li>
						...
						<div class="logo_container">
							<a href="index.php">
								<div class="logo_content d-flex flex-column align-items-start justify-content-center">
									...
									<div class="logo_sub">Pdt. Eliezeri waruwu, M.Th</div>
								</div>
							</a>
						</div>
					</div>
