					...
					<div class="col-lg-4 footer_col">
						<div class="footer_about">
								...
								<a href="index.php" class="d-flex flex-column align-items-center justify-content-center">
									<div class="logo_content">
										<div class="logo d-flex flex-row align-items-center justify-content-center">
											<div class="logo_text">GPPK<span>BEKASI</span></div>
							...
							<div class="footer_about_text">
								<p>Mari datang beribadah di Gereja GPPK Bekasi</p>
							</div>
							<ul class="footer_about_list">
								<li><div class="footer_about_icon"><img src="images/phone-call.svg" alt=""></div><span>+64 852-7794-8885</span></li>
								<li><div class="footer_about_icon"><img src="images/envelope.svg" alt=""></div><span>gppkbekasi@gmail.com</span></li>
								<li><div class="footer_about_icon"><img src="images/placeholder.svg" alt=""></div><span>Jln.Budi Kemasyarakatan No. 5 Pulo Brayan Kota, Bekasi</span></li>
							</ul>
						</div>
					</div>
				...
				<div class="row">
					<div class="col">
						<div class="copyright_content d-flex flex-lg-row flex-column align-items-lg-center justify-content-start">
							<div class="cr"> GPPK BEKASI <i aria-hidden="true"></i> Dev <a href="https://arsipcode.com" target="_blank">GPPK Bekasi </a>
